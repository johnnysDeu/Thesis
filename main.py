...
if __name__ == "__main__":
    ...
    Current_dir = "C:\\Users\\doitsinis\\PycharmProjects\\Thesis\\Crawler_results_Germany"
    ...
    for fold in list(subfolders):
        ...
        # identifying all black, all white or all same color img
...
if __name__ == "__main__":
    image_path = "C:\\Users\\doitsinis\\PycharmProjects\\Thesis\\folder_108\\iframe_101.jpg"
    ...
    #result = functions.identify_image_color(image_path)
    #print(result)
